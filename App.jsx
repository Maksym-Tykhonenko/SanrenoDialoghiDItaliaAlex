...
const App = () => {
  ...
  const INITIAL_URL = `https://prime-wave-pro.site/`;
  const URL_IDENTIFAIRE = `s4SOR5Yz`;
  ...
  OneSignal.initialize('eebbb405-3e4b-46c5-a5b4-bca7aa2f94fe');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-11-17T08:08:00'); //дата з якої поч працювати webView
